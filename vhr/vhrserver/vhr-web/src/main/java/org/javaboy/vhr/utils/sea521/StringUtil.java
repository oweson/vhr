...
//        return text.toLowerCase().hashCode();
	 ...
	 * 将数组平成一个字符串
	 */
	public static String getStrByStringArr(String[] arr) {
		String result;
		if (arr.length == 0) {
			result = "";
		} else {
	...
	/**
	 * 将list<String>中的项以，分割拼成字符串
	 * 
	 * @param list
	 * @return
	 */
	public static String getStrByStrList(List<String> list) {
		StringBuffer sb = new StringBuffer();
		for (int i = 0; i < list.size(); i++) {
			sb.append(list.get(i));
			if (i != list.size() - 1) {
	...
	public static String getCodeStrByStrList(List<String> list) {
		StringBuffer sb = new StringBuffer();
		for (int i = 0; i < list.size(); i++) {
	...
	/**
	 * 将Integer[]中的项以，分割拼成字符串
	 * 
	 * @param list
	 * @return
	 */
	public static String getStrByArr(Integer[] arr) {
		StringBuffer sb = new StringBuffer();
	 ...
	 * @return
	 */
	public static List<Integer> stringArrToIntegerList(String[] arr) {
	 ...
	 * 
	 */
	public static Integer[] stringArrToIntegerArr(String[] arr) {
	...
	public static String getStrByObjectList(Collection<Object> list) {
		StringBuffer sb = new StringBuffer();
		for (Object obj : list) {
	 ...
	 * @return
	 */
	public static Boolean isStringField(Object obj) {
		Boolean flag = false;
